      ...
      <div className="container mx-auto px-4 py-20 flex flex-col lg:flex-row items-center relative z-10">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <button 
              className="px-8 py-3 bg-yellow-500 text-blue-900 rounded-lg font-semibold 
                ...
                transform hover:-translate-y-1 active:translate-y-0 active:bg-yellow-600"
            >
              Get Started
            </button>
        ...
        >
          <div className="relative">
            ...
            <div 
              className="absolute top-5 -left-5 p-4 bg-white rounded-lg shadow-lg transform transition-all duration-500 hover:-translate-y-2 hover:shadow-xl"
              style={{
            ...
            <div 
              className="absolute top-1/3 -right-5 p-4 bg-white rounded-lg shadow-lg transform transition-all duration-500 hover:-translate-y-2 hover:shadow-xl"
              style={{
                transform: `translateX(${mousePosition.x * 20}px) translateY(${mousePosition.y * -20}px)`,
                transition: 'transform 0.1s ease-out',
              }}
            ...
            <div 
              className="absolute bottom-5 left-5 p-4 bg-white rounded-lg shadow-lg transform transition-all duration-500 hover:-translate-y-2 hover:shadow-xl"
              style={{
                transform: `translateX(${mousePosition.x * -20}px) translateY(${mousePosition.y * 20}px)`,
                transition: 'transform 0.1s ease-out',
              }}
